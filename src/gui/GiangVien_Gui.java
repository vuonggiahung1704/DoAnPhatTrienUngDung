...
import gui_dialog.GiangVien_Dialog;
 ...
 * @author nmrhu
 */
public class GiangVien_Gui extends javax.swing.JPanel {

	/**
	 * Creates new form QuanLyTaiKhoan_Gu
	 */
	public GiangVien_Gui() {
	...
	private void initComponents() {
		...
		jLabel1.setText("Danh mục / Giảng viên");
		...
		btnCapNhat.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				GiangVien_Dialog dialog = new GiangVien_Dialog(main, true);
				dialog.setTitle("Cập nhật giảng viên");
		...
		}, new String[] { "Mã giảng viên", "Họ tên", "Giới tính", "Khoa", "SĐT", "Email" }) {
	...
	public void xoaGiangVien() {
		int hoi = JOptionPane.showConfirmDialog(this,
				"Bạn có chắc chắn xóa " + gv.getMaGV() + " - " + gv.getHoTen() + " không ?", "Chú ý",
				JOptionPane.YES_NO_OPTION);
		if (hoi == JOptionPane.YES_OPTION) {
			try {
				qlgv.delete(gv.getMaGV());
				DocDuLieuDatabaseVaoTable("", 0, null);
				clear();
	...
	public void DocDuLieuDatabaseVaoTable(String txt, int timTheo, Khoa k) {
		...
		if (timTheo == 1) {
			...
			if (txt.equals(""))
				list = qlgv.dsGiangVien();
			else {
				list = qlgv.tim_GiangVien(txt);
			}
		}

		for (GiangVien gv : list) {
			Khoa khoa = qlkhoa.chiTietKhoa(gv.getKhoa().getMaKhoa());
			String gioiTinh = "";
			if (gv.getGioiTinh() == 0)
				gioiTinh = "Nữ";
			else
			...
			dm.addRow(new Object[] { gv.getMaGV(), gv.getHoTen(), gioiTinh, khoa.getTenKhoa(), gv.getSdt(),
					gv.getEmail() });
		}
	}
